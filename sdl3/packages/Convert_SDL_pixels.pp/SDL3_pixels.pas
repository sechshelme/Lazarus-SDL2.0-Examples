...
{
  Automatically converted by H2Pas 1.0.0 from SDL_pixels.h
...
function SDL_GetPixelFormatName(format:TUint32):Pchar;cdecl;external;
{*
...
function SDL_GetMasksForPixelFormatEnum(format:TUint32; bpp:Plongint; Rmask:PUint32; Gmask:PUint32; Bmask:PUint32; 
...
(* Const before type ignored *)
procedure SDL_GetRGBA(pixel:TUint32; format:PSDL_PixelFormat; r:PUint8; g:PUint8; b:PUint8; 
            a:PUint8);cdecl;external;
