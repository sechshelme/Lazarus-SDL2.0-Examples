 ...
 */
extern  int  SDL_SetClipboardData(SDL_ClipboardDataCallback callback, SDL_ClipboardCleanupCallback cleanup, void *userdata, const char **mime_types, size_t num_mime_types);
 ...
 * \sa SDL_SetClipboardData
 */
extern  int  SDL_ClearClipboardData(void);
 ...
 * \sa SDL_GetClipboardData
 */
extern  SDL_bool  SDL_HasClipboardData(const char *mime_type);
