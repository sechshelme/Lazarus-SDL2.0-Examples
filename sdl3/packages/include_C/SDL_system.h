...
typedef SDL_bool ( *SDL_WindowsMessageHook)(void *userdata, MSG *msg);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_Direct3D9GetAdapterIndex(SDL_DisplayID displayID);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_DXGIGetOutputInfo(SDL_DisplayID displayID, int *adapterIndex, int *outputIndex);
 ...
 */
extern  int  SDL_AndroidGetExternalStorageState(Uint32 *state);
...
typedef void ( *SDL_AndroidRequestPermissionCallback)(void *userdata, const char *permission, SDL_bool granted);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_AndroidRequestPermission(const char *permission, SDL_AndroidRequestPermissionCallback cb, void *userdata);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_AndroidSendMessage(Uint32 command, int param);
 ...
 */
extern  int  SDL_GDKGetDefaultUser(XUserHandle * outUserHandle);
