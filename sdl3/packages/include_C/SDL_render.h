 ...
 */
extern  SDL_Renderer *  SDL_CreateRenderer(SDL_Window *window, const char *name, Uint32 flags);
 ...
 * \sa SDL_GetRenderer
 */
extern  int  SDL_GetRenderOutputSize(SDL_Renderer *renderer, int *w, int *h);
 ...
 * \sa SDL_GetRenderer
 */
extern  int  SDL_GetCurrentRenderOutputSize(SDL_Renderer *renderer, int *w, int *h);
 ...
 */
extern  int  SDL_SetTextureColorModFloat(SDL_Texture *texture, float r, float g, float b);
 ...
 * \sa SDL_SetTextureColorModFloat
 */
extern  int  SDL_GetTextureColorModFloat(SDL_Texture *texture, float *r, float *g, float *b);
 ...
 * \sa SDL_SetTextureColorModFloat
 */
extern  int  SDL_SetTextureAlphaModFloat(SDL_Texture *texture, float alpha);
 ...
 * \sa SDL_SetTextureAlphaModFloat
 */
extern  int  SDL_GetTextureAlphaModFloat(SDL_Texture *texture, float *alpha);
 ...
 */
extern  int  SDL_SetRenderLogicalPresentation(SDL_Renderer *renderer, int w, int h, SDL_RendererLogicalPresentation mode, SDL_ScaleMode scale_mode);
 ...
 */
extern  int  SDL_GetRenderLogicalPresentation(SDL_Renderer *renderer, int *w, int *h, SDL_RendererLogicalPresentation *mode, SDL_ScaleMode *scale_mode);
 ...
 */
extern  int  SDL_RenderCoordinatesFromWindow(SDL_Renderer *renderer, float window_x, float window_y, float *x, float *y);
 ...
 * \sa SDL_SetRenderScale
 */
extern  int  SDL_RenderCoordinatesToWindow(SDL_Renderer *renderer, float x, float y, float *window_x, float *window_y);
 ...
 */
extern  int  SDL_ConvertEventToRenderCoordinates(SDL_Renderer *renderer, SDL_Event *event);
 ...
 */
extern  int  SDL_SetRenderViewport(SDL_Renderer *renderer, const SDL_Rect *rect);
 ...
 */
extern  int  SDL_GetRenderViewport(SDL_Renderer *renderer, SDL_Rect *rect);
 ...
 * \sa SDL_SetRenderViewport
 */
extern  SDL_bool  SDL_RenderViewportSet(SDL_Renderer *renderer);
 ...
 */
extern  int  SDL_SetRenderClipRect(SDL_Renderer *renderer, const SDL_Rect *rect);
 ...
 */
extern  int  SDL_GetRenderClipRect(SDL_Renderer *renderer, SDL_Rect *rect);
 ...
 * \sa SDL_SetRenderClipRect
 */
extern  SDL_bool  SDL_RenderClipEnabled(SDL_Renderer *renderer);
 ...
 */
extern  int  SDL_SetRenderScale(SDL_Renderer *renderer, float scaleX, float scaleY);
 ...
 * \sa SDL_SetRenderScale
 */
extern  int  SDL_GetRenderScale(SDL_Renderer *renderer, float *scaleX, float *scaleY);
 ...
 */
extern  int  SDL_SetRenderDrawColorFloat(SDL_Renderer *renderer, float r, float g, float b, float a);
 ...
 * \sa SDL_GetRenderDrawColor
 */
extern  int  SDL_GetRenderDrawColorFloat(SDL_Renderer *renderer, float *r, float *g, float *b, float *a);
 ...
 */
extern  int  SDL_SetRenderColorScale(SDL_Renderer *renderer, float scale);
 ...
 */
extern  int  SDL_GetRenderColorScale(SDL_Renderer *renderer, float *scale);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderPoint(SDL_Renderer *renderer, float x, float y);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderPoints(SDL_Renderer *renderer, const SDL_FPoint *points, int count);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderLine(SDL_Renderer *renderer, float x1, float y1, float x2, float y2);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderLines(SDL_Renderer *renderer, const SDL_FPoint *points, int count);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderRect(SDL_Renderer *renderer, const SDL_FRect *rect);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderRects(SDL_Renderer *renderer, const SDL_FRect *rects, int count);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderFillRects(SDL_Renderer *renderer, const SDL_FRect *rects, int count);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderTexture(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FRect *dstrect);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenderTextureRotated(SDL_Renderer *renderer, SDL_Texture *texture,
 ...
 * \sa SDL_Vertex
 */
extern  int  SDL_RenderGeometryRawFloat(SDL_Renderer *renderer,
                                               SDL_Texture *texture,
                                               const float *xy, int xy_stride,
 ...
 * \sa SDL_SetRenderDrawColor
 */
extern  int  SDL_RenderPresent(SDL_Renderer *renderer);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_FlushRenderer(SDL_Renderer *renderer);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetRenderVSync(SDL_Renderer *renderer, int vsync);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetRenderVSync(SDL_Renderer *renderer, int *vsync);
