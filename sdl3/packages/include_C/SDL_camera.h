 ...
 * \sa SDL_OpenCamera
 */
extern  SDL_CameraDeviceID * SDL_GetCameraDevices(int *count);
 ...
 */
extern  SDL_CameraSpec * SDL_GetCameraDeviceSupportedFormats(SDL_CameraDeviceID devid, int *count);
 ...
 * \sa SDL_GetCameraDevices
 */
extern  char *  SDL_GetCameraDeviceName(SDL_CameraDeviceID instance_id);
 ...
 * \sa SDL_GetCameraDevices
 */
extern  SDL_CameraPosition  SDL_GetCameraDevicePosition(SDL_CameraDeviceID instance_id);
 ...
 * \sa SDL_GetCameraFormat
 */
extern  SDL_Camera * SDL_OpenCameraDevice(SDL_CameraDeviceID instance_id, const SDL_CameraSpec *spec);
 ...
 * \sa SDL_OpenCameraDevice
 */
extern  SDL_CameraDeviceID  SDL_GetCameraInstanceID(SDL_Camera *camera);
 ...
 * \sa SDL_OpenCameraDevice
 */
extern  int  SDL_GetCameraFormat(SDL_Camera *camera, SDL_CameraSpec *spec);
 ...
 */
extern  int  SDL_ReleaseCameraFrame(SDL_Camera *camera, SDL_Surface *frame);
