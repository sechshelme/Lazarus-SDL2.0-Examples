 ...
 */
extern  SDL_PenID * SDL_GetPens(int *count);
 ...
 * \since This function is available since SDL 3.0.0
 */
extern  Uint32  SDL_GetPenStatus(SDL_PenID instance_id, float *x, float *y, float *axes, size_t num_axes);
 ...
 * \sa SDL_GUID
 */
extern  SDL_PenID  SDL_GetPenFromGUID(SDL_GUID guid);
 ...
 * \sa SDL_PenForID
 */
extern  SDL_GUID  SDL_GetPenGUID(SDL_PenID instance_id);
 ...
 * \since This function is available since SDL 3.0.0
 */
extern  SDL_bool  SDL_PenConnected(SDL_PenID instance_id);
 ...
 * \since This function is available since SDL 3.0.0
 */
extern  const char * SDL_GetPenName(SDL_PenID instance_id);
 ...
 * \since This function is available since SDL 3.0.0
 */
extern  Uint32  SDL_GetPenCapabilities(SDL_PenID instance_id, SDL_PenCapabilityInfo *capabilities);
 ...
 * \since This function is available since SDL 3.0.0
 */
extern  SDL_PenSubtype  SDL_GetPenType(SDL_PenID instance_id);
