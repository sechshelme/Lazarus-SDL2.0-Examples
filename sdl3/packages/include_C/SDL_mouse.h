 ...
 * \sa SDL_PumpEvents
 */
extern  Uint32  SDL_GetMouseState(float *x, float *y);
 ...
 * \sa SDL_CaptureMouse
 */
extern  Uint32  SDL_GetGlobalMouseState(float *x, float *y);
 ...
 */
extern  Uint32  SDL_GetRelativeMouseState(float *x, float *y);
