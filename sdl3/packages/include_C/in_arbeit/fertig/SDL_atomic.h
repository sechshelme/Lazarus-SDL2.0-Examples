 ...
 */
extern  SDL_bool  SDL_TryLockSpinlock(SDL_SpinLock *lock);
 ...
 * \sa SDL_AtomicSet
 */
extern  SDL_bool  SDL_AtomicCompareAndSwap(SDL_AtomicInt *a, int oldval, int newval);
 ...
 * \sa SDL_AtomicGet
 */
extern  int  SDL_AtomicSet(SDL_AtomicInt *a, int v);
 ...
 * \sa SDL_AtomicSet
 */
extern  int  SDL_AtomicGet(SDL_AtomicInt *a);
 ...
 * \sa SDL_AtomicIncRef
 */
extern  int  SDL_AtomicAdd(SDL_AtomicInt *a, int v);
 ...
 * \sa SDL_AtomicSetPtr
 */
extern  SDL_bool  SDL_AtomicCompareAndSwapPointer(void **a, void *oldval, void *newval);
