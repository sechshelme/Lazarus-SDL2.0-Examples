 ...
 * \sa SDL_WaitSemaphoreTimeout
 */
extern  int  SDL_WaitSemaphore(SDL_Semaphore *sem);
 ...
 * \sa SDL_WaitSemaphoreTimeout
 */
extern  int  SDL_TryWaitSemaphore(SDL_Semaphore *sem);
 ...
 * \sa SDL_WaitSemaphore
 */
extern  int  SDL_WaitSemaphoreTimeout(SDL_Semaphore *sem, Sint32 timeoutMS);
 ...
 * \sa SDL_WaitSemaphoreTimeout
 */
extern  int  SDL_PostSemaphore(SDL_Semaphore *sem);
 ...
 * \sa SDL_DestroyCondition
 */
extern  int  SDL_SignalCondition(SDL_Condition *cond);
 ...
 * \sa SDL_DestroyCondition
 */
extern  int  SDL_BroadcastCondition(SDL_Condition *cond);
 ...
 * \sa SDL_DestroyCondition
 */
extern  int  SDL_WaitCondition(SDL_Condition *cond, SDL_Mutex *mutex);
 ...
 * \sa SDL_DestroyCondition
 */
extern  int  SDL_WaitConditionTimeout(SDL_Condition *cond,
