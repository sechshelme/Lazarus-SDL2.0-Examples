 ...
 */
typedef int ( *SDL_blit) (struct SDL_Surface *src, const SDL_Rect *srcrect,
 ...
 */
extern  SDL_Surface * SDL_CreateSurface
 ...
 * \sa SDL_DestroySurface
 */
extern  SDL_Surface * SDL_CreateSurfaceFrom
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetSurfaceColorspace(SDL_Surface *surface, SDL_Colorspace colorspace);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetSurfaceColorspace(SDL_Surface *surface, SDL_Colorspace *colorspace);
 ...
 * \sa SDL_SaveBMP_RW
 */
extern  SDL_Surface * SDL_LoadBMP_RW(SDL_RWops *src, SDL_bool freesrc);
 ...
 * \sa SDL_SaveBMP
 */
extern  int  SDL_SaveBMP_RW(SDL_Surface *surface, SDL_RWops *dst, SDL_bool freedst);
 ...
 */
extern  SDL_bool  SDL_SurfaceHasRLE(SDL_Surface *surface);
 ...
 */
extern  int  SDL_SetSurfaceColorKey(SDL_Surface *surface, int flag, Uint32 key);
 ...
 * \sa SDL_GetSurfaceColorKey
 */
extern  SDL_bool  SDL_SurfaceHasColorKey(SDL_Surface *surface);
 ...
 * \sa SDL_SetSurfaceColorKey
 */
extern  int  SDL_GetSurfaceColorKey(SDL_Surface *surface, Uint32 *key);
 ...
 */
extern  SDL_bool  SDL_SetSurfaceClipRect(SDL_Surface *surface, const SDL_Rect *rect);
 ...
 */
extern  int  SDL_GetSurfaceClipRect(SDL_Surface *surface, SDL_Rect *rect);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_FlipSurface(SDL_Surface *surface, SDL_FlipMode flip);
 ...
 * \sa SDL_CreateSurface
 */
extern  SDL_Surface * SDL_ConvertSurface(SDL_Surface *surface, const SDL_PixelFormat *format);
 ...
 * \sa SDL_CreateSurface
 */
extern  SDL_Surface * SDL_ConvertSurfaceFormat(SDL_Surface *surface, Uint32 pixel_format);
 ...
 * \sa SDL_CreateSurface
 */
extern  SDL_Surface * SDL_ConvertSurfaceFormatAndColorspace(SDL_Surface *surface, Uint32 pixel_format, SDL_Colorspace colorspace, SDL_PropertiesID props);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_ConvertPixelsAndColorspace(int width, int height, Uint32 src_format, SDL_Colorspace src_colorspace, SDL_PropertiesID src_properties, const void *src, int src_pitch, Uint32 dst_format, SDL_Colorspace dst_colorspace, SDL_PropertiesID dst_properties, void *dst, int dst_pitch);
 ...
 */
extern  int  SDL_FillSurfaceRect(SDL_Surface *dst, const SDL_Rect *rect, Uint32 color);
 ...
 */
extern  int  SDL_FillSurfaceRects(SDL_Surface *dst, const SDL_Rect *rects, int count, Uint32 color);
 ...
 * \sa SDL_BlitSurface
 */
extern  int  SDL_BlitSurfaceUnchecked(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect);
 ...
 * \sa SDL_BlitSurface
 */
extern  int  SDL_BlitSurfaceScaled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect, SDL_ScaleMode scaleMode);
 ...
 * \sa SDL_BlitSurfaceScaled
 */
extern  int  SDL_BlitSurfaceUncheckedScaled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect, SDL_ScaleMode scaleMode);
