 ...
 * \sa SDL_OpenHaptic
 */
extern  const char * SDL_GetHapticInstanceName(SDL_HapticID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_Haptic * SDL_GetHapticFromInstanceID(SDL_HapticID instance_id);
 ...
 * \sa SDL_OpenHaptic
 */
extern  SDL_HapticID  SDL_GetHapticInstanceID(SDL_Haptic *haptic);
 ...
 * \sa SDL_OpenHapticFromMouse
 */
extern  SDL_bool  SDL_IsMouseHaptic(void);
 ...
 * \sa SDL_OpenHapticFromJoystick
 */
extern  SDL_bool  SDL_IsJoystickHaptic(SDL_Joystick *joystick);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern  SDL_bool  SDL_HapticEffectSupported(SDL_Haptic *haptic, const SDL_HapticEffect *effect);
 ...
 * \sa SDL_RunHapticEffect
 */
extern  int  SDL_UpdateHapticEffect(SDL_Haptic *haptic, int effect, const SDL_HapticEffect *data);
 ...
 */
extern  int  SDL_RunHapticEffect(SDL_Haptic *haptic, int effect, Uint32 iterations);
 ...
 * \sa SDL_RunHapticEffect
 */
extern  int  SDL_StopHapticEffect(SDL_Haptic *haptic, int effect);
 ...
 * \sa SDL_StopHapticEffect
 */
extern  int  SDL_GetHapticEffectStatus(SDL_Haptic *haptic, int effect);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern  int  SDL_SetHapticGain(SDL_Haptic *haptic, int gain);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern  int  SDL_SetHapticAutocenter(SDL_Haptic *haptic, int autocenter);
 ...
 * \sa SDL_ResumeHaptic
 */
extern  int  SDL_PauseHaptic(SDL_Haptic *haptic);
 ...
 * \sa SDL_PauseHaptic
 */
extern  int  SDL_ResumeHaptic(SDL_Haptic *haptic);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_StopHapticEffects(SDL_Haptic *haptic);
 ...
 */
extern  SDL_bool  SDL_HapticRumbleSupported(SDL_Haptic *haptic);
 ...
 */
extern  int  SDL_InitHapticRumble(SDL_Haptic *haptic);
 ...
 * \sa SDL_HapticRumbleSupported
 */
extern  int  SDL_PlayHapticRumble(SDL_Haptic *haptic, float strength, Uint32 length);
 ...
 * \sa SDL_HapticRumbleSupported
 */
extern  int  SDL_StopHapticRumble(SDL_Haptic *haptic);
