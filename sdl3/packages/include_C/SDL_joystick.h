 ...
 * \sa SDL_OpenJoystick
 */
extern  const char * SDL_GetJoystickInstanceName(SDL_JoystickID instance_id);
 ...
 * \sa SDL_OpenJoystick
 */
extern  const char * SDL_GetJoystickInstancePath(SDL_JoystickID instance_id);
 ...
 * \sa SDL_OpenJoystick
 */
extern  int  SDL_GetJoystickInstancePlayerIndex(SDL_JoystickID instance_id);
 ...
 */
extern  SDL_JoystickGUID  SDL_GetJoystickInstanceGUID(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  Uint16  SDL_GetJoystickInstanceVendor(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  Uint16  SDL_GetJoystickInstanceProduct(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  Uint16  SDL_GetJoystickInstanceProductVersion(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_JoystickType  SDL_GetJoystickInstanceType(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_Joystick * SDL_GetJoystickFromInstanceID(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_JoystickID  SDL_AttachVirtualJoystick(SDL_JoystickType type,
                                                      int naxes,
                                                      int nbuttons,
                                                      int nhats);
...
typedef struct SDL_VirtualJoystickDesc
{
    ...
    int ( *Rumble)(void *userdata, Uint16 low_frequency_rumble, Uint16 high_frequency_rumble); /**< Implements SDL_RumbleJoystick() */
    int ( *RumbleTriggers)(void *userdata, Uint16 left_rumble, Uint16 right_rumble); /**< Implements SDL_RumbleJoystickTriggers() */
    int ( *SetLED)(void *userdata, Uint8 red, Uint8 green, Uint8 blue); /**< Implements SDL_SetJoystickLED() */
    int ( *SendEffect)(void *userdata, const void *data, int size); /**< Implements SDL_SendJoystickEffect() */
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_JoystickID  SDL_AttachVirtualJoystickEx(const SDL_VirtualJoystickDesc *desc);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_DetachVirtualJoystick(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_IsJoystickVirtual(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetJoystickVirtualAxis(SDL_Joystick *joystick, int axis, Sint16 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetJoystickVirtualButton(SDL_Joystick *joystick, int button, Uint8 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetJoystickVirtualHat(SDL_Joystick *joystick, int hat, Uint8 value);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetJoystickPlayerIndex(SDL_Joystick *joystick, int player_index);
 ...
 * \sa SDL_GetJoystickGUIDString
 */
extern  SDL_JoystickGUID  SDL_GetJoystickGUID(SDL_Joystick *joystick);
 ...
 */
extern  int  SDL_GetJoystickGUIDString(SDL_JoystickGUID guid, char *pszGUID, int cbGUID);
 ...
 * \sa SDL_GetJoystickGUIDString
 */
extern  SDL_JoystickGUID  SDL_GetJoystickGUIDFromString(const char *pchGUID);
 ...
 * \sa SDL_OpenJoystick
 */
extern  SDL_bool  SDL_JoystickConnected(SDL_Joystick *joystick);
 ...
 * \sa SDL_OpenJoystick
 */
extern  SDL_JoystickID  SDL_GetJoystickInstanceID(SDL_Joystick *joystick);
 ...
 */
extern  void  SDL_SetJoystickEventsEnabled(SDL_bool enabled);
 ...
 */
extern  SDL_bool  SDL_JoystickEventsEnabled(void);
 ...
 */
extern  Sint16  SDL_GetJoystickAxis(SDL_Joystick *joystick,
                                                   int axis);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_GetJoystickAxisInitialState(SDL_Joystick *joystick,
 ...
 */
extern  Uint8  SDL_GetJoystickHat(SDL_Joystick *joystick,
                                                 int hat);
 ...
 */
extern  Uint8  SDL_GetJoystickButton(SDL_Joystick *joystick,
                                                    int button);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RumbleJoystick(SDL_Joystick *joystick, Uint16 low_frequency_rumble, Uint16 high_frequency_rumble, Uint32 duration_ms);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RumbleJoystickTriggers(SDL_Joystick *joystick, Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetJoystickLED(SDL_Joystick *joystick, Uint8 red, Uint8 green, Uint8 blue);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SendJoystickEffect(SDL_Joystick *joystick, const void *data, int size);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_JoystickPowerLevel  SDL_GetJoystickPowerLevel(SDL_Joystick *joystick);
