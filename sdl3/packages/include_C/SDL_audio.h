 ...
 */
extern  SDL_AudioDeviceID * SDL_GetAudioOutputDevices(int *count);
 ...
 */
extern  SDL_AudioDeviceID * SDL_GetAudioCaptureDevices(int *count);
 ...
 */
extern  char * SDL_GetAudioDeviceName(SDL_AudioDeviceID devid);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetAudioDeviceFormat(SDL_AudioDeviceID devid, SDL_AudioSpec *spec, int *sample_frames);
 ...
 */
extern  int  SDL_PauseAudioDevice(SDL_AudioDeviceID dev);
 ...
 */
extern  int  SDL_ResumeAudioDevice(SDL_AudioDeviceID dev);
 ...
 * \sa SDL_ResumeAudioDevice
 */
extern  SDL_bool  SDL_AudioDevicePaused(SDL_AudioDeviceID dev);
 ...
 */
extern  int  SDL_BindAudioStreams(SDL_AudioDeviceID devid, SDL_AudioStream **streams, int num_streams);
 ...
 * \sa SDL_GetAudioStreamDevice
 */
extern  int  SDL_BindAudioStream(SDL_AudioDeviceID devid, SDL_AudioStream *stream);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetAudioStreamFormat(SDL_AudioStream *stream,
 ...
 */
extern  int  SDL_SetAudioStreamFormat(SDL_AudioStream *stream,
 ...
 */
extern  int  SDL_SetAudioStreamFrequencyRatio(SDL_AudioStream *stream, float ratio);
 ...
 * \sa SDL_DestroyAudioStream
 */
extern  int  SDL_PutAudioStreamData(SDL_AudioStream *stream, const void *buf, int len);
 ...
 * \sa SDL_DestroyAudioStream
 */
extern  int  SDL_FlushAudioStream(SDL_AudioStream *stream);
 ...
 * \sa SDL_DestroyAudioStream
 */
extern  int  SDL_ClearAudioStream(SDL_AudioStream *stream);
 ...
 */
extern  int  SDL_LockAudioStream(SDL_AudioStream *stream);
 ...
 * \sa SDL_SetAudioStreamGetCallback
 */
extern  int  SDL_UnlockAudioStream(SDL_AudioStream *stream);
 ...
 * \sa SDL_SetAudioStreamPutCallback
 */
extern  int  SDL_SetAudioStreamGetCallback(SDL_AudioStream *stream, SDL_AudioStreamCallback callback, void *userdata);
 ...
 * \sa SDL_SetAudioStreamGetCallback
 */
extern  int  SDL_SetAudioStreamPutCallback(SDL_AudioStream *stream, SDL_AudioStreamCallback callback, void *userdata);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetAudioPostmixCallback(SDL_AudioDeviceID devid, SDL_AudioPostmixCallback callback, void *userdata);
 ...
 * \sa SDL_LoadWAV
 */
extern  int  SDL_LoadWAV_RW(SDL_RWops * src, SDL_bool freesrc,
 ...
 * \sa SDL_LoadWAV_RW
 */
extern  int  SDL_LoadWAV(const char *path, SDL_AudioSpec * spec,
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_MixAudioFormat(Uint8 * dst,
                                               const Uint8 * src,
 ...
 * \sa SDL_CreateAudioStream
 */
extern  int  SDL_ConvertAudioSamples(const SDL_AudioSpec *src_spec,
