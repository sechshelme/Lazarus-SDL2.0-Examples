 ...
 * \sa SDL_GetDisplays
 */
extern  int  SDL_GetDisplayBounds(SDL_DisplayID displayID, SDL_Rect *rect);
 ...
 * \sa SDL_GetDisplays
 */
extern  int  SDL_GetDisplayUsableBounds(SDL_DisplayID displayID, SDL_Rect *rect);
 ...
 * \sa SDL_GetDisplays
 */
extern  const SDL_DisplayMode ** SDL_GetFullscreenDisplayModes(SDL_DisplayID displayID, int *count);
 ...
 * \sa SDL_GetFullscreenDisplayModes
 */
extern  const SDL_DisplayMode * SDL_GetClosestFullscreenDisplayMode(SDL_DisplayID displayID, int w, int h, float refresh_rate, SDL_bool include_high_density_modes);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_SetWindowFullscreenMode(SDL_Window *window, const SDL_DisplayMode *mode);
 ...
 */
extern  SDL_Window * SDL_CreatePopupWindow(SDL_Window *parent, int offset_x, int offset_y, int w, int h, Uint32 flags);
 ...
 * \sa SDL_GetWindowTitle
 */
extern  int  SDL_SetWindowTitle(SDL_Window *window, const char *title);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetWindowIcon(SDL_Window *window, SDL_Surface *icon);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_SetWindowPosition(SDL_Window *window, int x, int y);
 ...
 * \sa SDL_SetWindowPosition
 */
extern  int  SDL_GetWindowPosition(SDL_Window *window, int *x, int *y);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_SetWindowSize(SDL_Window *window, int w, int h);
 ...
 * \sa SDL_SetWindowSize
 */
extern  int  SDL_GetWindowSize(SDL_Window *window, int *w, int *h);
 ...
 * \sa SDL_GetWindowSize
 */
extern  int  SDL_GetWindowSizeInPixels(SDL_Window *window, int *w, int *h);
 ...
 */
extern  int  SDL_SetWindowMinimumSize(SDL_Window *window, int min_w, int min_h);
 ...
 */
extern  int  SDL_GetWindowMinimumSize(SDL_Window *window, int *w, int *h);
 ...
 * \sa SDL_SetWindowMinimumSize
 */
extern  int  SDL_SetWindowMaximumSize(SDL_Window *window, int max_w, int max_h);
 ...
 * \sa SDL_SetWindowMaximumSize
 */
extern  int  SDL_GetWindowMaximumSize(SDL_Window *window, int *w, int *h);
 ...
 * \sa SDL_GetWindowFlags
 */
extern  int  SDL_SetWindowBordered(SDL_Window *window, SDL_bool bordered);
 ...
 * \sa SDL_GetWindowFlags
 */
extern  int  SDL_SetWindowResizable(SDL_Window *window, SDL_bool resizable);
 ...
 * \sa SDL_GetWindowFlags
 */
extern  int  SDL_SetWindowAlwaysOnTop(SDL_Window *window, SDL_bool on_top);
 ...
 * \sa SDL_ShowWindow
 */
extern  int  SDL_HideWindow(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RaiseWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_MaximizeWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_MinimizeWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_RestoreWindow(SDL_Window *window);
 ...
 * \sa SDL_SyncWindow
 */
extern  int  SDL_SetWindowFullscreen(SDL_Window *window, SDL_bool fullscreen);
 ...
 * \sa SDL_RestoreWindow
 */
extern  int  SDL_SyncWindow(SDL_Window *window);
 ...
 */
extern  SDL_bool  SDL_WindowHasSurface(SDL_Window *window);
 ...
 * \sa SDL_GetWindowGrab
 */
extern  int  SDL_SetWindowGrab(SDL_Window *window, SDL_bool grabbed);
 ...
 * \sa SDL_SetWindowGrab
 */
extern  int  SDL_SetWindowKeyboardGrab(SDL_Window *window, SDL_bool grabbed);
 ...
 * \sa SDL_SetWindowGrab
 */
extern  int  SDL_SetWindowMouseGrab(SDL_Window *window, SDL_bool grabbed);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetWindowFocusable(SDL_Window *window, SDL_bool focusable);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_ShowWindowSystemMenu(SDL_Window *window, int x, int y);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetWindowShape(SDL_Window *window, SDL_Surface *shape);
 ...
 */
extern  SDL_bool  SDL_ScreenSaverEnabled(void);
 ...
 */
extern  int  SDL_EnableScreenSaver(void);
 ...
 * \sa SDL_ScreenSaverEnabled
 */
extern  int  SDL_DisableScreenSaver(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_EGLDisplay  SDL_EGL_GetCurrentEGLDisplay(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_EGLConfig  SDL_EGL_GetCurrentEGLConfig(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_EGLSurface  SDL_EGL_GetWindowEGLSurface(SDL_Window *window);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  void  SDL_EGL_SetEGLAttributeCallbacks(SDL_EGLAttribArrayCallback platformAttribCallback,
 ...
 */
extern  int  SDL_GL_GetSwapInterval(int *interval);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GL_SwapWindow(SDL_Window *window);
 ...
 * \sa SDL_GL_CreateContext
 */
extern  int  SDL_GL_DeleteContext(SDL_GLContext context);
