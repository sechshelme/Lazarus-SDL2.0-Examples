...
{ was #define dname(params) para_def_expr }
{ argument types are unknown }
function SDL_AUDIO_ISFLOAT(x : longint) : LongInt;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
function SDL_AUDIO_ISBIGENDIAN(x : longint) : LongInt;
...
{ was #define dname(params) para_def_expr }
{ argument types are unknown }
function SDL_AUDIO_ISSIGNED(x : longint) : LongInt;
...
function SDL_ConvertAudioSamples(src_spec:PSDL_AudioSpec; src_data:PUint8; src_len:longint; dst_spec:PSDL_AudioSpec; dst_data:PPUint8; 
           dst_len:Plongint):longint;cdecl;external;
{*
