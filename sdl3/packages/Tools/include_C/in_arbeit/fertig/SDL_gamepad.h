 ...
 * \sa SDL_GetGamepadMappingForGUID
 */
extern  int  SDL_AddGamepadMappingsFromRW(SDL_RWops *src, SDL_bool freesrc);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_ReloadGamepadMappings(void);
 ...
 */
extern  char *  SDL_GetGamepadMappingForGUID(SDL_JoystickGUID guid);
 ...
 * \sa SDL_GetGamepadMapping
 */
extern  int  SDL_SetGamepadMapping(SDL_JoystickID instance_id, const char *mapping);
 ...
 * \sa SDL_OpenGamepad
 */
extern  SDL_bool  SDL_IsGamepad(SDL_JoystickID instance_id);
 ...
 * \sa SDL_OpenGamepad
 */
extern  const char * SDL_GetGamepadInstanceName(SDL_JoystickID instance_id);
 ...
 * \sa SDL_OpenGamepad
 */
extern  const char * SDL_GetGamepadInstancePath(SDL_JoystickID instance_id);
 ...
 * \sa SDL_OpenGamepad
 */
extern  int  SDL_GetGamepadInstancePlayerIndex(SDL_JoystickID instance_id);
 ...
 */
extern  SDL_JoystickGUID  SDL_GetGamepadInstanceGUID(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  Uint16  SDL_GetGamepadInstanceVendor(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  Uint16  SDL_GetGamepadInstanceProduct(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  Uint16  SDL_GetGamepadInstanceProductVersion(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_GamepadType  SDL_GetGamepadInstanceType(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_GamepadType  SDL_GetRealGamepadInstanceType(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  char * SDL_GetGamepadInstanceMapping(SDL_JoystickID instance_id);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_Gamepad * SDL_GetGamepadFromInstanceID(SDL_JoystickID instance_id);
 ...
 * \sa SDL_OpenGamepad
 */
extern  SDL_JoystickID  SDL_GetGamepadInstanceID(SDL_Gamepad *gamepad);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetGamepadPlayerIndex(SDL_Gamepad *gamepad, int player_index);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_JoystickPowerLevel  SDL_GetGamepadPowerLevel(SDL_Gamepad *gamepad);
 ...
 * \sa SDL_OpenGamepad
 */
extern  SDL_bool  SDL_GamepadConnected(SDL_Gamepad *gamepad);
 ...
 */
extern  void  SDL_SetGamepadEventsEnabled(SDL_bool enabled);
 ...
 */
extern  SDL_bool  SDL_GamepadEventsEnabled(void);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_GamepadHasAxis(SDL_Gamepad *gamepad, SDL_GamepadAxis axis);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_GamepadHasButton(SDL_Gamepad *gamepad, SDL_GamepadButton button);
 ...
 */
extern  Uint8  SDL_GetGamepadButton(SDL_Gamepad *gamepad, SDL_GamepadButton button);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetGamepadTouchpadFinger(SDL_Gamepad *gamepad, int touchpad, int finger, Uint8 *state, float *x, float *y, float *pressure);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_GamepadHasSensor(SDL_Gamepad *gamepad, SDL_SensorType type);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetGamepadSensorEnabled(SDL_Gamepad *gamepad, SDL_SensorType type, SDL_bool enabled);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  SDL_bool  SDL_GamepadSensorEnabled(SDL_Gamepad *gamepad, SDL_SensorType type);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetGamepadSensorData(SDL_Gamepad *gamepad, SDL_SensorType type, float *data, int num_values);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RumbleGamepad(SDL_Gamepad *gamepad, Uint16 low_frequency_rumble, Uint16 high_frequency_rumble, Uint32 duration_ms);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RumbleGamepadTriggers(SDL_Gamepad *gamepad, Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SetGamepadLED(SDL_Gamepad *gamepad, Uint8 red, Uint8 green, Uint8 blue);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_SendGamepadEffect(SDL_Gamepad *gamepad, const void *data, int size);
