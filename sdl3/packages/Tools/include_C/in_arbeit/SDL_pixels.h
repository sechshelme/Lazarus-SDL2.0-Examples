 ...
 */
extern  SDL_bool  SDL_GetMasksForPixelFormatEnum(Uint32 format,
                                                            int *bpp,
                                                            Uint32 * Rmask,
                                                            Uint32 * Gmask,
                                                            Uint32 * Bmask,
 ...
 */
extern  Uint32  SDL_GetPixelFormatEnumForMasks(int bpp,
                                                          Uint32 Rmask,
                                                          Uint32 Gmask,
                                                          Uint32 Bmask,
                                                          Uint32 Amask);
 ...
 */
extern  SDL_PixelFormat *  SDL_CreatePixelFormat(Uint32 pixel_format);
 ...
 */
extern  void  SDL_DestroyPixelFormat(SDL_PixelFormat *format);
