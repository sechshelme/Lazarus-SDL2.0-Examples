...
{$ELSE}
procedure GLDebugCallBack(Source: TGLEnum; type_: TGLEnum; id: TGLUInt; severity: TGLUInt; length: TGLsizei; const message_: PGLCHar; userParam: PGLvoid); cdecl;
{$ENDIF}
...
begin
  ...
  glDebugMessageControl(GL_DONT_CARE, GL_DONT_CARE, GL_DONT_CARE, 0, nil, 1);
end;
