...
var
  ...
  begin
    ...
    gTextTexture := TLTexture.Create(gRenderer);
  end;

  function loadMedia: boolean;
  var
    sucess: boolean = True;
    textColor: TSDL_Color = (r: 0; g: 0; b: 0; a: 0);
  begin
    ...
    if gFont = nil then begin
      ...
      if not gTextTexture.LoadFromRenderedText(gFont, 'The quick brown fox jumps over the lazy dog', textColor) then begin
  ...
  if not init then begin
    ...
    if not loadMedia then begin
      ...
      while not quit do begin
        ...
        gTextTexture.Render((Screen_Widht - gTextTexture.Widht) div 2, (Screen_Height - gTextTexture.Height) div 2);
